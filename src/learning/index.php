...
/** html書き出し用 */
$output_folder = dirname(ROOT_PATH) . '/public/' . $project_name . '/learning/';
...
foreach ($folders_to_copy as $folder_name) {
    ...
    $destination_folder = __DIR__ . '/../public/' . $project_name . '/learning/' . $folder_name;
